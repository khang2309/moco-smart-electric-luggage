...
for (const [name, region] of [
  ["page-bg", { left: 50, top: 300, width: 40, height: 40 }],
  ["card-bg", { left: 120, top: 350, width: 40, height: 40 }],
  ["audience-card", { left: 200, top: 900, width: 40, height: 40 }],
  ["audience-title", { left: 800, top: 830, width: 40, height: 20 }],
]) {
